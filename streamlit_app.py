...
# ========== SESSION INIT/RESET TRIGGERS ==========
if 'reset_trigger' not in st.session_state:
    st.session_state.reset_trigger = False
if 'example_trigger' not in st.session_state:
    st.session_state.example_trigger = False

# Reset to defaults before any widgets are created
if st.session_state.reset_trigger:
    for key, val in DEFAULTS.items():
        st.session_state[key] = val
    st.session_state.reset_trigger = False

# Set example values before any widgets are created
...
# ========== SIDEBAR WIDGETS (All use session state keys) ==========
...
# ========== ACTION BUTTONS (use flag-based approach) ==========
...
# ========== Run and Visualize Simulation (unchanged) ==========
...
# Visualization tabs (same as your previous working code)
if st.session_state.simulation_data is not None:
    # ... (Insert your visualization/tabs code here; unchanged)
    pass
else:
